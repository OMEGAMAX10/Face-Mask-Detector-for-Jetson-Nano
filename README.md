...
foo@bar:~$ sudo ./install_dependencies_jetson_nano.sh           # run the script to install dependencies of the application
```
...
6. Despite the fact that you can take manually photos from the main menu, the application makes each of the connected cameras capable of taking photos automatically with whenever its state switches to "Warning" or "Danger".
